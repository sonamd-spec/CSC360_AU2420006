...
Overall, this session gave me a basic understanding of how computers represent and work with graphics. I understood the difference between raster and vector images and also learned how graphical objects can be created and modified using Java. The concepts of translation, scaling and rotation were especially useful because they show how objects can be manipulated in a program. I also got an introduction to Git, SSH, interpolators and Linux, which are useful for programming and development. The practical examples of moving a triangle and zooming helped me connect the theoretical concepts with actual applications.
